...
ID мода: CELADON_BASIC_TRANSLATION
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/basic_translation.dm`: `BASIC_TRANSLATION_SPEED_MULTIPLIER`, `BASIC_TRANSLATION_SPEED_BASE`
-->
