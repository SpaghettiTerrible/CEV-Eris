...
/datum/modpack/basic_translation
...
// Инициализация ДО
/datum/modpack/basic_translation/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/basic_translation/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/basic_translation/post_initialize()
	. = ..()
